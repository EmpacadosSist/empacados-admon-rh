...
$sheet->setTitle('scorecard');  // Cambiar el nombre de la hoja aquí

// Establecer el nombre del archivo a descargar
$filename = "plantilla_scorecard.xlsx";

// Escribir los encabezados
$sheet->setCellValue('A1', 'Id de indicador');
$sheet->setCellValue('B1', 'Nombre del indicador');
$sheet->setCellValue('C1', 'Real');
$sheet->setCellValue('D1', 'Objetivo');
$sheet->setCellValue('E1', 'Formato');
...
$row = 2;  // Empezamos en la fila 2 porque la 1 tiene los encabezados
for ($i = 0; $i < count($indicadores); $i++) {
    $sheet->setCellValue('A' . $row, $indicadores[$i]['id']);
