...
<head>
  ...
  <title>Informacion de mis empleados Empacados</title>
...
.card-title {
  ...
  <main id="main" class="main">
    ...
    <img src="assets/img/arroz12.png" width="200" height="50" alt="Arroz" id="as">
              ...
              <h2 align="text-center" id="title" class="animate__animated animate__bounceInRight card-title">Información de mis Empleados
    ...
    <ul class="nav nav-tabs" id="pestanas" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" id="pestaña1-tab" data-toggle="tab" href="#contenido1" role="tab" aria-controls="contenido1" aria-selected="true">Empleados-oficina</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" id="pestaña2-tab" data-toggle="tab" href="#contenido2" role="tab" aria-controls="contenido2" aria-selected="false">Empleados-planta</a>
      </li>
        <li class="nav-item">
        <a class="nav-link" id="pestaña2-tab" data-toggle="tab" href="#contenido2" role="tab" aria-controls="contenido2" aria-selected="false">Empleados años anteriores</a>
      </li>
      ...
      <div class="tab-pane fade show active" id="contenido1" role="tabpanel" aria-labelledby="pestaña1-tab">
        <table class="table table-striped table-bordered" id="myTable1" style="font-size:74%;">
          ...
          <tbody>
            ...
            <td>Masculino</td>
            <td>Soltero</td>
            <td>Av. Principal 789, Ciudad QRS</td>
            <td>555-345-6789</td>
