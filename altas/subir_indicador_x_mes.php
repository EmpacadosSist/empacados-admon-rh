...
if(count($_POST)>0){
  ...
  if($indicatorNameVal && $commentsVal && $valueTypeIdVal && $realValueVal && $targetValueVal && $calculationTypeVal && $areaIdVal){    
    ...
    $sqlSP="CALL insert_indicator_per_month('$indicatorName', '$comments', $valueTypeId, '$realValue', '$targetValue', $calculationType, $areaId, @ind_last_id, @vpm_last_id)";
