  ...
  if($vacationsPeriodIdVal && $estatusLetraVal && $empNumVal && $nombreVal && $requestedDaysVal && $correoVal && $reasonVal){    
    ...
    */
    ...
    if(true){
      ...
      $datos = ["numEmpleado"=>$empNum,"nombre"=>$nombre,"correo"=>$correo,"dias"=>$requestedDays, "estatus"=>$estatusLetra, "motivo"=>$reason];
      ...
      $resultado = ["ok"=>true,"message"=>"Enviado","datos"=>$datos];
