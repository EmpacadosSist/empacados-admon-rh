...
if(count($_POST)>0){
  ...
  $areaIdVal = Validar::validarNum($areaId);
    ...
    if($areaIdVal){
      ...
      $resultado = ["ok"=>false,"message"=>"Error en la validación de información", "Id de area"=>$areaIdVal];
    }
}else{
