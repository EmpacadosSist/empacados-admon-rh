...
function notificarRespuesta($datos)
{
    ...
    if($datos['estatus']=='R'){
      ...
      //esto solo se muestra cuando se rechaza la solicitud de cualquier tipo ------^^^^^^^^^^^^    
		...
		$message .= '<a style="color:#000000;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:135%;" href="'.URL_REDIRECCION.'conecta-empacados/historial-vacaciones.php'.$tab.'" target="_blank">Ver en la web</a>';        
		$message .= '</td>';
		$message .= '<td>';
		$message .= '</td>';
